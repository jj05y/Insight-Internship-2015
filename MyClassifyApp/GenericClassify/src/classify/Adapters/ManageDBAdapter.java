...
public class ManageDBAdapter extends BaseAdapter {
    ...
    public ManageDBAdapter(Context context, ArrayList<Row> rows, Fragment parentFrag, DatabaseHandler db) {
    ...
    public View getView(int pos, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            myInflatedView = inflater.inflate(R.layout.row_item_manage, null);
        } else {
