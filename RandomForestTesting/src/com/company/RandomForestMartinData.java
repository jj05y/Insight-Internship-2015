 ...
 * 
 */
public class RandomForestMartinData {
    ...
    public static void main(String[] args) throws Exception {
        /* Load a data set */
        Dataset data = FileHandler.loadDataset(new File("orig122.csv"), 0, ",");
        /*
         ...
         * same one.
         */
        Dataset dataForClassification = FileHandler.loadDataset(new File("origBinary.csv"), 0, ",");
